...
$est_parcelles = (strpos($script_name, '/admin/parcelles/') !== false);
$est_proprietaires = (strpos($script_name, '/admin/proprietaires/') !== false);
$est_alertes = (strpos($script_name, '/admin/alertes/') !== false);
$est_litiges = (strpos($script_name, '/admin/litiges/') !== false);
...
<aside class="sidebar-wrapper p-3">
    ...
    <nav class="d-flex flex-column gap-2 flex-grow-1 overflow-auto">
        ...
        <a href="/foncier_gloV3/admin/parcelles/index.php" class="text-decoration-none d-flex align-items-center gap-3 nav-link-custom <?php echo $est_parcelles ? 'active' : ''; ?>">
            <span class="material-symbols-outlined" <?php echo $est_parcelles ? 'style="font-variation-settings: \'FILL\' 1;"' : ''; ?>>map</span> 
            Parcelles
        </a>
        <a href="/foncier_gloV3/admin/proprietaires/index.php" class="text-decoration-none d-flex align-items-center gap-3 nav-link-custom <?php echo $est_proprietaires ? 'active' : ''; ?>">
            <span class="material-symbols-outlined" <?php echo $est_proprietaires ? 'style="font-variation-settings: \'FILL\' 1;"' : ''; ?>>person_pin</span> 
            Propriétaires
        </a>
        <a href="/foncier_gloV3/admin/alertes/index.php" class="text-decoration-none d-flex align-items-center gap-3 nav-link-custom <?php echo $est_alertes ? 'active' : ''; ?>">
            <span class="material-symbols-outlined" <?php echo $est_alertes ? 'style="font-variation-settings: \'FILL\' 1;"' : ''; ?>>warning</span> 
            Alertes
        </a>
        <a href="/foncier_gloV3/admin/litiges/index.php" class="text-decoration-none d-flex align-items-center gap-3 nav-link-custom <?php echo $est_litiges ? 'active' : ''; ?>">
...
<div class="main-content">
    ...
    <header class="topbar d-flex justify-content-between align-items-center shadow-sm">
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <form action="/foncier_gloV3/admin/parcelles/index.php" method="GET" class="position-relative d-none d-md-block">
